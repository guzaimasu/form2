<?php
// PHP BACKEND - HANDLE FORM SUBMISSIONS
...
// If not a POST request, show the normal HTML page
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<style>
/* ALL YOUR CSS STYLES - KEEP EVERYTHING EXACTLY THE SAME */
:root {
    --primary-blue: #2563EB;
    --primary-red: #DC2626;
    --blue-light: #3B82F6;
...
chatForm.addEventListener('submit', async e => {
    ...
    try {
        // Send message using FormData (works with the PHP at the top)
        const formData = new FormData();
        formData.append('message', message);
        
        const response = await fetch('', {  // Empty string = submit to same file
            method: 'POST',
            body: formData
        });
